...
' sTopKey - A top level registry key abbreviation {"HKCU","HKLM","HKU","HKDD","HKCC","HKCR"}
' sSubKey - A registry subkey.
' sKeyName - The name of the key to delete.
...
'
' NOTE: The key to be deleted cannot be a top-level key and cannot have any sub-keys.
'
Dim lTopKey As Long
Dim lHandle As Long
Dim lResult As Long

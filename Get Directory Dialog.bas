...
'------------------------------------------------------------------------------
' from Stephen Fonnesbeck, steev@xmission.com, http://www.xmission.com/~steev
' to include satarting folder and dialog title, 31. August 2007
'------------------------------------------------------------------------------
Public Function GetDirectoryDialogA(sForm As Form, DialogTitle As String, StartFolder As String) As String
...
Dim tBrowseInfo             As BrowseInfo
    ...
    m_CurrentDirectory = StartFolder & vbNullChar

    szTitle = DialogTitle
    With tBrowseInfo
        .hWndOwner = sForm.hWnd
        .lpszTitle = lstrcat(szTitle, "")
        .ulFlags = BIF_RETURNONLYFSDIRS + BIF_DONTGOBELOWDOMAIN + BIF_STATUSTEXT
...
errhandler:
    GetDirectoryDialogA = vbNullString
